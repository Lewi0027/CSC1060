...
Title: Mancala 9
Due: 5/9/2022
Description: Putting the entire program together
*/
...
int main( )
{
	...
	int turnNumber = 0; // Variable to help determine whose turn it is
...
void dropBeads( int player, int beadArray[MAX] )
{
  ...
  // Problems: The example strings are not working... I cannot figure out why.