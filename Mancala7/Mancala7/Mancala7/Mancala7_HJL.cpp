...
Title: Mancala 7
Due: 4/28/2022
Description: Creating the getStartingBin function
*/
...
int main( )
{
	...
	int player = 2; // Which player is currently going
...
int getStartingBin( int player, int beadArray[MAX] )
{
	...
	{
		cout << "Not a valid bin, not your bin. Choose another bin." << endl;
		cin >> binChoice;
	}
...
// Problems: I had problems understanding what to accomplish.